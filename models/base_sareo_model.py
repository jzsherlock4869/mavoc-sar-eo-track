...
from data.sareo_dataloader import get_trainval_sareo_dataloader, get_test_sareo_dataloader
...
class BaseSAREOModel:
    ...
    def inference_with_calibr(self):
        ...
        pred_class = class_calibration_v2(all_probs_test)
